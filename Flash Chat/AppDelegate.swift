...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        // that is gonna be impelement before anything
        ...
        //(2)
        //this is for testing purpose if entire! database recive data from our app
        //if you put this code and continue with your app it will not be with history of messages
        // so we took a reference from a entire data base not a child!
